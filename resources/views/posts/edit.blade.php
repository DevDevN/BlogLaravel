        ...
        <form action="/" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-12">
                <div class="px-4 md:w-1/2 lg:w-1/3">
                    <div class="mb-12">
                        <label for="Content" class="mb-[10px] block text-base font-medium text-dark dark:text-white">
                        </label>
                        <textarea rows="5" placeholder="" name="content"
                            class="w-[600px] bg-transparent rounded-md border border-stroke dark:border-dark-3 p-5 text-dark-6 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-gray-2">{{ $post->content }}</textarea>
                    </div>
                </div>
            </div>
            </p>
            ...
            <div class="flex flex-wrap -mx-3">
                ...
                <div class="w-1/2 px-3">
                    <a href="{{ route('posts.update', $post)}}" type="submit"
